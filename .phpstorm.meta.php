...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/john/turtle-scout-v2/public/storage' => 'string',
...
'app.scout.ajax_refresh_interval','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider',
...
'broadcasting.connections.reverb.secret','broadcasting.connections.reverb.app_id','broadcasting.connections.reverb.allowed_origins','broadcasting.connections.reverb.options.host','broadcasting.connections.reverb.options.port',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/john/turtle-scout-v2/public/storage','hashing.driver',
...
'mail.markdown.theme','mail.markdown.paths','meta_tags.title.default','meta_tags.title.separator','meta_tags.title.max_length',
'meta_tags.description.default','meta_tags.description.max_length','meta_tags.keywords.default','meta_tags.keywords.max_length','meta_tags.packages',
'meta_tags.charset','meta_tags.robots','meta_tags.viewport','meta_tags.csrf_token','queue.default',
