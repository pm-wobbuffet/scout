...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.sqid.alphabet' => 'string',
            'app.scout.default_expansion_id' => 'string',
            'app.scout.version_history_lockout' => 'string',
            'app.scout.ajax_refresh_interval' => 'string',
            'app.scout.old_reports_migrated' => 'boolean',
...
'app.aliases.View','app.aliases.Vite','app.sqid.alphabet','app.scout.default_expansion_id','app.scout.version_history_lockout',
'app.scout.ajax_refresh_interval','app.scout.old_reports_migrated','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'horizon.environments.production.supervisor-1.balanceMaxShift','horizon.environments.production.supervisor-1.balanceCooldown','horizon.environments.local.supervisor-1.maxProcesses','horizon.watch','logging.default',
...
'mail.from.address','mail.from.name','mail.markdown.theme','mail.markdown.paths','meta_tags.title.default',
'meta_tags.title.separator','meta_tags.title.max_length','meta_tags.description.default','meta_tags.description.max_length','meta_tags.keywords.default',
'meta_tags.keywords.max_length','meta_tags.packages','meta_tags.charset','meta_tags.robots','meta_tags.viewport',
'meta_tags.csrf_token','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','reverb.default','reverb.servers.reverb.host',
...
'reverb.apps.apps.0.ping_interval','reverb.apps.apps.0.activity_timeout','reverb.apps.apps.0.max_connections','reverb.apps.apps.0.max_message_size','laravelcloudflare.enabled',
...
'help.index','maps.index','scout.view','scout.assignmob','scout.clearpoint',
'scout.updatemobstatus','scout.updatelist','scout.updateOccupiedPoint','scout.updateMeta','scout.importPoints',
'scout.revert','scout.updateinstances','scout.finalize','scout.clone','admin.dashboard',
'admin.zones','admin.zones.instances','admin.zones.edit','admin.zones.spawn_points.index','admin.zones.spawn_points.create',
'admin.zones.spawn_points.store','admin.zones.spawn_points.show','admin.zones.spawn_points.edit','admin.zones.spawn_points.update','admin.zones.spawn_points.destroy',
